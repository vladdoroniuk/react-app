...
const mapDispatchToProps = (dispatch: Dispatch) => {
  return {
    wsCheckConnected: (isConnected: boolean) =>
      dispatch(wsHealthCheckConnected(isConnected)),
    setCurrentActiveGroup: (groupUrl: string) =>
      dispatch(setCurrentActiveGroup(groupUrl)),
...
export const WebSocketMainContainer = connect(
  null,
  mapDispatchToProps
