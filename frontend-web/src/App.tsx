    ...
    <Router>
      ...
      <Switch>
        <Route
          exact
          path="/"
          render={(props: any) => <HomeContainer {...props} />}
        />
        <Route
          exact
          path="/create"
          render={(props: any) => <CreateGroupContainer {...props} />}
        />
        <Route
          exact
          path="/t/messages"
          render={(props: any) => <WebSocketMainContainer {...props} />}
        />
        ...
        <Route
          ...
          path="/register"
          render={(props: any) => (
            <RegisterFormComponent {...props} history={history} />
          )}
        />
        <Route
          exact
          path="/login"
          render={(props: any) => (
            <LoginContainer {...props} history={history} />
          )}
        />
      </Switch>
      <AlertComponent />
